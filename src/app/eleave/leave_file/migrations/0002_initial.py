...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='leavefile',
            name='leave_id',
            field=models.ForeignKey(db_column='leave_id', on_delete=django.db.models.deletion.CASCADE, related_name='leave_files', to='leave_request.leaverequest'),
        ),
        migrations.AddField(
            model_name='leavefile',
            name='updated_by',
